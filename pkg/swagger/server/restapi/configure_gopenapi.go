...
//go:generate swagger generate server --target ../../server --name Gopenapi --spec ../../swagger.yml --exclude-main

func configureFlags(api *operations.GopenapiAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.GopenapiAPI) http.Handler {
